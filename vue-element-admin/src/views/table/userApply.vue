...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      const { id, affiliation, country, name, status, page = 1, limit = 20, sort } = this.listQuery
    ...
    createData() {
      this.$refs["dataForm"].validate(valid => {
        if (valid) {
          ...
          createApply(this.temp).then(response => {
